...
export const Technologies = (props) => { 
  return (
    <svg
      ...
      data-prefix="fas"
      data-icon="wrench"
      className="prefix__svg-inline--fa prefix__fa-wrench prefix__fa-w-16"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 512 512"
      {...props}
    >
